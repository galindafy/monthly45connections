document.addEventListener("DOMContentLoaded", () => {
  const SIZE = 45;
  const STORAGE_KEY = "connections-45x45-weekly-v2";
  ...
  const CATEGORY_BANK = {
    ...
    "BOARD GAMES": ["Monopoly","Scrabble","Clue","Risk","Catan","Ticket to Ride","Pandemic board game","Carcassonne","Sorry!","Battleship board game","Life board game","Checkers","Chess","Connect Four","Candy Land","Mouse Trap","Operation board game","Yahtzee","Trouble","Guess Who?","Pictionary","Taboo","Codenames board game","Boggle","Trivial Pursuit","Sequence","Azul","Splendor","Dominion","Agricola","Root board game","Wingspan","Patchwork","Blokus","Stratego","Uno board game","Jenga","Mastermind","Labyrinth","Mancala","Twister board game","The Game of Things","Scattergories","Quoridor","Hive"],
    "CARD GAMES": ["Uno card game","Poker","Bridge","Hearts","Spades","Rummy","Go Fish","Crazy Eights","Old Maid","War card game","Blackjack","Solitaire","Gin Rummy","Canasta","Euchre","Pinochle","Cribbage","Skip-Bo","Phase 10","Exploding Kittens","Cards Against Humanity","Magic: The Gathering","Pokemon TCG","Yu-Gi-Oh!","President","Durak","Mao","Snap","Spoons","Whist","Set card game","Dutch Blitz","Monopoly Deal","Coup","Love Letter","Fluxx","Dominion cards","Nerts","Baccarat","Kemps","Golf card game","Slapjack","Pit","Uno Flip","Tichu"],
    "MUSICAL INSTRUMENTS": ["piano","guitar","violin","drums","flute","clarinet","trumpet","saxophone","cello","harp","trombone","tuba","oboe","bassoon","ukulele","banjo","mandolin","accordion","harmonica","xylophone","marimba","conga","bongo","tambourine","triangle instrument","recorder","double bass","electric bass","electric guitar","synthesizer","keyboard instrument","bagpipes","didgeridoo","sitar","tabla","gong","castanets","cymbals","snare drum","bass drum","piccolo","French horn","viola","lute","theremin"],
    ...
    "BEVERAGES": ["coffee","tea","water","sparkling water","cola","orange juice","apple juice","milk","hot chocolate","latte drink","espresso drink","cappuccino","mocha drink","matcha latte","lemonade","iced tea","smoothie beverage","milkshake beverage","root beer","ginger ale","tonic water","club soda","kombucha","chai tea","herbal tea","green tea","black tea","oolong tea","white tea","coconut water","sports drink","energy drink","tomato juice","grapefruit juice","cranberry juice","pineapple juice","mango lassi","bubble tea","cold brew","americano","flat white","macchiato","frappuccino","oat milk","horchata"],
    "WEATHER WORDS": ["rain","snow","sleet","hail","fog","mist","cloud","sunshine","thunder","lightning","wind","breeze","gust","hurricane","tornado","drizzle","downpour","blizzard","flurries","heatwave","drought","humidity","forecast","barometer","front weather","rainbow","ice storm","dew","frost","whiteout","overcast","clear skies","partly cloudy","monsoon","cyclone","storm surge","cold snap","wind chill","UV index","smog","haze","puddle","sun shower","squall","thunderstorm"],
  ...
  function displayWord(word) {
    return word
      .replace(/\s+(film|song|novel|app|platform|service|book|game|company|vehicle|drink|beverage|instrument|colour|weather|social|streaming|quick service|board game|card game|tea)$/i, "")
      .replace(/\s+\[.*?\]$/, "")
      .trim();
  }
